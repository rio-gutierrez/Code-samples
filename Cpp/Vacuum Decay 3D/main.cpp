...
//            //*************************************************************************************************
//            //              Output 11 instantons (one for each tau_max value) to different .csv file for each e
//            //*************************************************************************************************
//            if (e==0){
//                if (tau_max == 120) {
//                    ofstream myfile ("../lambda=1.20/instanton/e=0/num_data_strong1.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
//                                myfile << Phi.at(i).at(j) << endl;
//                            else
//                                myfile << Phi.at(i).at(j) << ",";
//                        }
//
//                    }
//                    myfile.close();
//                }   else if (tau_max == 110){
//                    ofstream myfile ("../lambda=1.20/instanton/e=0/num_data_strong2.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 100){
//                    ofstream myfile ("../lambda=1.20/instanton/e=0/num_data_strong3.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 90){
//                    ofstream myfile ("../lambda=1.20/instanton/e=0/num_data_strong4.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 80){
//                    ofstream myfile ("../lambda=1.20/instanton/e=0/num_data_strong5.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 70){
//                    ofstream myfile ("../lambda=1.20/instanton/e=0/num_data_strong6.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 60){
//                    ofstream myfile ("../lambda=1.20/instanton/e=0/num_data_strong7.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 50){
//                    ofstream myfile ("../lambda=1.20/instanton/e=0/num_data_strong8.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 40){
//                    ofstream myfile ("../lambda=1.20/instanton/e=0/num_data_strong9.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 30){
//                    ofstream myfile ("../lambda=1.20/instanton/e=0/num_data_strong10.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 20){
//                    ofstream myfile ("../lambda=1.20/instanton/e=0/num_data_strong11.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//            } else if (e==1){
//                if (tau_max == 120) {
//                    ofstream myfile ("../lambda=1.20/instanton/e=1/num_data_strong1.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                    myfile.close();
//                }   else if (tau_max == 110){
//                    ofstream myfile ("../lambda=1.20/instanton/e=1/num_data_strong2.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 100){
//                    ofstream myfile ("../lambda=1.20/instanton/e=1/num_data_strong3.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 90){
//                    ofstream myfile ("../lambda=1.20/instanton/e=1/num_data_strong4.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 80){
//                    ofstream myfile ("../lambda=1.20/instanton/e=1/num_data_strong5.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 70){
//                    ofstream myfile ("../lambda=1.20/instanton/e=1/num_data_strong6.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 60){
//                    ofstream myfile ("../lambda=1.20/instanton/e=1/num_data_strong7.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 50){
//                    ofstream myfile ("../lambda=1.20/instanton/e=1/num_data_strong8.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 40){
//                    ofstream myfile ("../lambda=1.20/instanton/e=1/num_data_strong9.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 30){
//                    ofstream myfile ("../lambda=1.20/instanton/e=1/num_data_strong10.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 20){
//                    ofstream myfile ("../lambda=1.20/instanton/e=1/num_data_strong11.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//            } else if (e==2){
//                if (tau_max == 120) {
//                    ofstream myfile ("../lambda=1.20/instanton/e=2/num_data_strong1.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                    myfile.close();
//                }   else if (tau_max == 110){
//                    ofstream myfile ("../lambda=1.20/instanton/e=2/num_data_strong2.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 100){
//                    ofstream myfile ("../lambda=1.20/instanton/e=2/num_data_strong3.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 90){
//                    ofstream myfile ("../lambda=1.20/instanton/e=2/num_data_strong4.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 80){
//                    ofstream myfile ("../lambda=1.20/instanton/e=2/num_data_strong5.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 70){
//                    ofstream myfile ("../lambda=1.20/instanton/e=2/num_data_strong6.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 60){
//                    ofstream myfile ("../lambda=1.20/instanton/e=2/num_data_strong7.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 50){
//                    ofstream myfile ("../lambda=1.20/instanton/e=2/num_data_strong8.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 40){
//                    ofstream myfile ("../lambda=1.20/instanton/e=2/num_data_strong9.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 30){
//                    ofstream myfile ("../lambda=1.20/instanton/e=2/num_data_strong10.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 20){
//                    ofstream myfile ("../lambda=1.20/instanton/e=2/num_data_strong11.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//            } else if (e==3){
//                if (tau_max == 120) {
//                    ofstream myfile ("../lambda=1.20/instanton/e=3/num_data_strong1.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                    myfile.close();
//                }   else if (tau_max == 110){
//                    ofstream myfile ("../lambda=1.20/instanton/e=3/num_data_strong2.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 100){
//                    ofstream myfile ("../lambda=1.20/instanton/e=3/num_data_strong3.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 90){
//                    ofstream myfile ("../lambda=1.20/instanton/e=3/num_data_strong4.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 80){
//                    ofstream myfile ("../lambda=1.20/instanton/e=3/num_data_strong5.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 70){
//                    ofstream myfile ("../lambda=1.20/instanton/e=3/num_data_strong6.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 60){
//                    ofstream myfile ("../lambda=1.20/instanton/e=3/num_data_strong7.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 50){
//                    ofstream myfile ("../lambda=1.20/instanton/e=3/num_data_strong8.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 40){
//                    ofstream myfile ("../lambda=1.20/instanton/e=3/num_data_strong9.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 30){
//                    ofstream myfile ("../lambda=1.20/instanton/e=3/num_data_strong10.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 20){
//                    ofstream myfile ("../lambda=1.20/instanton/e=3/num_data_strong11.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//            } else if (e==4){
//                if (tau_max == 120) {
//                    ofstream myfile ("../lambda=1.20/instanton/e=4/num_data_strong1.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                    myfile.close();
//                }   else if (tau_max == 110){
//                    ofstream myfile ("../lambda=1.20/instanton/e=4/num_data_strong2.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 100){
//                    ofstream myfile ("../lambda=1.20/instanton/e=4/num_data_strong3.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 90){
//                    ofstream myfile ("../lambda=1.20/instanton/e=4/num_data_strong4.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 80){
//                    ofstream myfile ("../lambda=1.20/instanton/e=4/num_data_strong5.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 70){
//                    ofstream myfile ("../lambda=1.20/instanton/e=4/num_data_strong6.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 60){
//                    ofstream myfile ("../lambda=1.20/instanton/e=4/num_data_strong7.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 50){
//                    ofstream myfile ("../lambda=1.20/instanton/e=4/num_data_strong8.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 40){
//                    ofstream myfile ("../lambda=1.20/instanton/e=4/num_data_strong9.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 30){
//                    ofstream myfile ("../lambda=1.20/instanton/e=4/num_data_strong10.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//                }
//                else if (tau_max == 20){
//                    ofstream myfile ("../lambda=1.20/instanton/e=4/num_data_strong11.csv");
//                    //myfile.open ("num_data_strong.csv");
//                    for (int i{0}; i <= tau_max; i++) {
//                        for (int j {0}; j <= r_max; j++) {
//                            if (j == r_max)
...
//            }
            ...
            Phi.clear();   //crucial step I was missing earlier!!!
            pPhi.clear();
            nPhi.clear();
        ...
        //output action .csv files, one for each e
        if (e == 0) {
            ofstream actionfile ("../lambda=1.20/act_vs_temp/action1.csv");
            for (int i{0}; i <= ACTION.size()-1; i++) {
                actionfile << ACTION.at(i) << endl;
            }
            actionfile.close();
        } else if (e == 1){
            ofstream actionfile ("../lambda=1.20/act_vs_temp/action2.csv");
            for (int i{0}; i <= ACTION.size()-1; i++) {
                actionfile << ACTION.at(i) << endl;
            }
            actionfile.close();
        } else if (e == 2){
            ofstream actionfile ("../lambda=1.20/act_vs_temp/action3.csv");
            for (int i{0}; i <= ACTION.size()-1; i++) {
                actionfile << ACTION.at(i) << endl;
            }
            actionfile.close();
        } else if (e == 3){
            ofstream actionfile ("../lambda=1.20/act_vs_temp/action4.csv");
            for (int i{0}; i <= ACTION.size()-1; i++) {
                actionfile << ACTION.at(i) << endl;
            }
            actionfile.close();
        } else if (e == 4){
            ofstream actionfile ("../lambda=1.20/act_vs_temp/action5.csv");
            for (int i{0}; i <= ACTION.size()-1; i++) {
                actionfile << ACTION.at(i) << endl;
            }
            actionfile.close();
        ...
        if (e == 4){                                           //temp is the same for all 'e', so I'm just doing it for the last 'e' run to save some computational resources
            ofstream tempfile ("../lambda=1.20/act_vs_temp/temp.csv");
            for (int i{0}; i <= TEMP.size()-1; i++) {
                tempfile << TEMP.at(i) << endl;
            }
            tempfile.close();
        }
        ...
        //output radius .csv files, one for each e
        if (e == 0) {
            ofstream radiusfile ("../lambda=1.20/radius/radius1.csv");
            for (int i{0}; i <= RADIUS.size()-1; i++) {
                radiusfile << RADIUS.at(i) << endl;
            }
            radiusfile.close();
        } else if (e == 1){
            ofstream radiusfile ("../lambda=1.20/radius/radius2.csv");
            for (int i{0}; i <= RADIUS.size()-1; i++) {
                radiusfile << RADIUS.at(i) << endl;
            }
            radiusfile.close();
        } else if (e == 2){
            ofstream radiusfile ("../lambda=1.20/radius/radius3.csv");
            for (int i{0}; i <= RADIUS.size()-1; i++) {
                radiusfile << RADIUS.at(i) << endl;
            }
            radiusfile.close();
        } else if (e == 3){
            ofstream radiusfile ("../lambda=1.20/radius/radius4.csv");
            for (int i{0}; i <= RADIUS.size()-1; i++) {
                radiusfile << RADIUS.at(i) << endl;
            }
            radiusfile.close();
        } else if (e == 4){
            ofstream radiusfile ("../lambda=1.20/radius/radius5.csv");
            for (int i{0}; i <= RADIUS.size()-1; i++) {
                radiusfile << RADIUS.at(i) << endl;
            }
            radiusfile.close();
        ...
        //output tau radius .csv files, one for each e
        if (e == 0) {
            ofstream tauradiusfile ("../lambda=1.20/radius/tauradius1.csv");
            for (int i{0}; i <= RADIUS_tau.size()-1; i++) {
                tauradiusfile << RADIUS_tau.at(i) << endl;
            }
            tauradiusfile.close();
        } else if (e == 1){
            ofstream tauradiusfile ("../lambda=1.20/radius/tauradius2.csv");
            for (int i{0}; i <= RADIUS_tau.size()-1; i++) {
                tauradiusfile << RADIUS_tau.at(i) << endl;
            }
            tauradiusfile.close();
        } else if (e == 2){
            ofstream tauradiusfile ("../lambda=1.20/radius/tauradius3.csv");
            for (int i{0}; i <= RADIUS_tau.size()-1; i++) {
                tauradiusfile << RADIUS_tau.at(i) << endl;
            }
            tauradiusfile.close();
        } else if (e == 3){
            ofstream tauradiusfile ("../lambda=1.20/radius/tauradius4.csv");
            for (int i{0}; i <= RADIUS_tau.size()-1; i++) {
                tauradiusfile << RADIUS_tau.at(i) << endl;
            }
            tauradiusfile.close();
        } else if (e == 4){
            ofstream tauradiusfile ("../lambda=1.20/radius/tauradius5.csv");
            for (int i{0}; i <= RADIUS_tau.size()-1; i++) {
                tauradiusfile << RADIUS_tau.at(i) << endl;
            }
            tauradiusfile.close();
